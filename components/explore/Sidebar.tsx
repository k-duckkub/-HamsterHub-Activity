...
export default function Sidebar({ active = 'explore' }: { active?: string }) {
  const reduced = useReducedMotion() ?? false

  return (
    <aside className="z-20 flex shrink-0 flex-col border-line bg-warm px-4 py-3 lg:w-[210px] lg:border-r lg:px-5 lg:py-8">
            ...
            return (
              <li key={id} className="flex-1 lg:flex-none">
                <motion.button
                  ...
                  whileTap={reduced ? undefined : { scaleX: 0.98, scaleY: 0.94, y: 1 }}
                  ...
                  className={[
                    ...
                    isActive ? 'bg-surface text-primary' : 'text-body hover:bg-white/70',
                  ].join(' ')}
                >
                  <Icon
