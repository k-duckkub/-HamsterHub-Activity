...
2. จับคู่ไฟล์กับ slug ที่ `COVER_MAP` ใน `scripts/import-covers.mjs`
   ...
   ใส่ค่าที่สามเป็น `object-position` ได้ ถ้าครอปกลางแล้วกินส่วนสำคัญของภาพ
   เช่น `'center 32%'` ของ Game Pee Camp ที่ไม่งั้นจะกินหัวคำว่า UNITY
...
| `additional/game-pee-blox.jpg` | GAME PEE BLOX · ค่ายเกม 'ผี' บอก · 3–5 ก.ค. (Roblox) | คนละค่ายกับ Game Pee Camp ที่เป็น Unity 10–12 มิ.ย. และยังไม่มีกิจกรรมนี้ในข้อมูล |
