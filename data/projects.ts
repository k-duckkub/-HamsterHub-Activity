...
export const projects: Project[] = [
  // RobloxJam
  { id: 'rj-1', activitySlug: 'portfolio-5-years', title: 'นครลอยฟ้าแห่งเวทมนตร์', creator: 'NongGame', initial: 'N', viewers: '2.4K', views: 2400, daysAgo: 3, tint: ['#1B4B6B', '#0D1117'] },
  ...
  { id: 'gx-2', activitySlug: 'portfolio-5-years', title: 'ไม่มีปุ่มกระโดดในเกมนี้', creator: 'BeamBuilder', initial: 'B', viewers: '3.2K', views: 3200, daysAgo: 3, tint: ['#22405A', '#0D1117'] },
  ...
  { id: 'gj3-3', activitySlug: 'portfolio-5-years', title: 'สร้างสะพานด้วยของที่เหลืออยู่', creator: 'ArmCode', initial: 'A', viewers: '4.0K', views: 4000, daysAgo: 2, tint: ['#4A3A15', '#0D1117'] },
  ...
  { id: 'gj6-4', activitySlug: 'portfolio-5-years', title: 'ศัตรูจำทุกอย่างที่คุณทำ', creator: 'ArmCode', initial: 'A', viewers: '2.7K', views: 2700, daysAgo: 5, tint: ['#57291F', '#0D1117'] },
  ...
  // GameJam SP 2
  { id: 'sp2-1', activitySlug: 'hamster-hub-hybrid-game-jam', title: 'ด่านเดียวที่ยาวหนึ่งชั่วโมง', creator: 'ArmCode', initial: 'A', viewers: '3.9K', views: 3900, daysAgo: 1, tint: ['#1C3652', '#0D1117'] },
